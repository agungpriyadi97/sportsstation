...
WebUI.setText(findTestObject('SportsStation - Checkout/Cart - SportStation/Page_Sports Station/txtField_Email'), 'm.ibnuatho455@gmail.com')

WebUI.setText(findTestObject('SportsStation - Checkout/Cart - SportStation/Page_Sports Station/txtField_password'), '123abc')

WebUI.click(findTestObject('SportsStation - Checkout/Cart - SportStation/Page_Sports Station/button_Sign In'))

WebUI.verifyElementPresent(findTestObject('SportsStation - Checkout/Shipping - SportStation/Page_Sports Station/txt_Checkout'), 
    0)
