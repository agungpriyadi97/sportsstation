...
WebUI.verifyElementNotPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/msg_Password must be 6-16 characters including numbers and alphabets'), 
    0)

WebUI.verifyElementNotPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/msg_The password you entered are not the same'), 
    0)
