...
WebUI.verifyElementNotPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/msg_Please enter your first name'), 
    0)

WebUI.verifyElementNotPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/msg_Please enter your last name'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/msg_Minimum 18 years old'), 
    0)
