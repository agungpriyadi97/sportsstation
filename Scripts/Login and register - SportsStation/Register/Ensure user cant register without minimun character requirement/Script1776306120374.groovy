...
WebUI.click(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/txtField_confirmPassword'))

WebUI.verifyElementVisible(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/msg_Password must be 6-16 characters including numbers and alphabets'))
