...
WebUI.navigateToUrl(GlobalVariable.url_loginRegister)
...
WebUI.verifyElementNotPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/msg_You are required to agree to our data terms to proceed'), 
    0)
