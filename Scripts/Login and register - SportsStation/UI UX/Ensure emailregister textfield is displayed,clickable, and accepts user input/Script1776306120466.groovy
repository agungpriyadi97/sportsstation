...
WebUI.verifyElementPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/txtField_emailRegister'), 
    0)
...
WebUI.verifyElementAttributeValue(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/txtField_emailRegister'), 
    'value', 'ibnutesting@yopmail.com', 0)
