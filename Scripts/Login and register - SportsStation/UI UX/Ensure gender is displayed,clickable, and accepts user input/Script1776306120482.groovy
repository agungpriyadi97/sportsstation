...
WebUI.verifyElementPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/btn_newsletter'), 
    0)

WebUI.verifyElementClickable(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/btn_newsletter'))

WebUI.verifyElementPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/btn_privacyPolicy'), 
    0)

WebUI.verifyElementClickable(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/btn_privacyPolicy'))
