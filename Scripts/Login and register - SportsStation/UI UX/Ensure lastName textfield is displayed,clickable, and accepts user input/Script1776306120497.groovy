...
WebUI.verifyElementPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/txtField_lastName'), 
    0)

WebUI.verifyElementClickable(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/txtField_lastName'))
...
WebUI.verifyElementAttributeValue(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/Page_Sports Station/txtField_lastName'), 
    'value', 'bayern', 0)
