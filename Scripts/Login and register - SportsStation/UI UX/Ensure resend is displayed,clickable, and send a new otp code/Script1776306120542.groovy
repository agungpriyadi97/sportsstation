...
WebUI.waitForElementClickable(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/btn_resendCode'), 0)

WebUI.waitForElementPresent(findTestObject('SportStation-RegisterLogin/sportStation_RegisterObject/btn_resendCode'), 0)
