...
WebUI.waitForElementVisible(
    findTestObject('WEB/Address/Shipping/txt_FirstName'),
    10)
...
WebUI.setText(
    findTestObject('WEB/Address/Shipping/txt_LastName'),
    data.lastName)

WebUI.setText(
    findTestObject('WEB/Address/Shipping/txt_Mobile'),
    data.phone)

WebUI.setText(
    findTestObject('WEB/Address/Shipping/txt_Address'),
    data.address)
...
WebUI.click(
    findTestObject('WEB/Address/Shipping/ddl_Province'))

WebUI.click(
    findTestObject('WEB/Address/Shipping/opt_province'))
...
WebUI.waitForElementVisible(
    findTestObject('WEB/Address/Shipping/btn_Save'),
    10)
