...
println('NAVIGATE TO SPORTS PAGE')

println('===================================')

WebUI.waitForElementClickable(findTestObject('WEB/Home/Navbar/menu_Sports'), 20)

WebUI.click(findTestObject('WEB/Home/Navbar/menu_Sports'))

WebUI.waitForPageLoad(20)

WebUI.click(findTestObject('WEB/Common/txt_Search'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), '.*sports.*', true)
